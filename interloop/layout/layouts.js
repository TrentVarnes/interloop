...
export default function Layouts({ children }) {
  return (
    <div className="flex h-screen bg-gradient-to-tr from-slate-900 to-slate-700 shadow-[0_25px_50px_-3px_rgba(0,0,0,0.4)] duration-300 hover:drop-shadow-lg ">
      <div className="mx-auto my-56 items-center bg-slate-50 rounded-lg w-3/5 h-1/4 grid lg:grid-cols-2">
        <div className=" rounded-l-md bg-gradient-to-tr from-slate-700 to-slate-800">
