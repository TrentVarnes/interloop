    ...
    <div className="h-screen ">
      <div ref={el => el && setHeight(el.offsetHeight)}>
        ...
        <div className="w-screen h-sreen"></div>
          <div className="w-screen h-screen flex flex-col lg:flex-row bg-gradient-to-tr from-slate-900 to-slate-700 absolute">
            <div className="mx-auto flex flex-col flex-1 z-20 lg:px-28 lg:py-16 ">
              <div className="max-w-screen  mx-auto flex flex-col flex-1 z-20 items-left">
                ...
                <p className="text-sm mt-28 md:py-18 lg:py-24 text-white text-left z-20">Helping our clients connect their data, systems, and people to <br></br>optimize operations and confidently drive growth.</p>
              </div>
            </div>
